...
print("\nEmociones detectadas por orden de Keras:")
...
print("\nEntrenando emociones con optimización suavizada...\n")
...
modelo.save("modelo/emocion.keras")
print("\nModelo emociones guardado exitosamente.")
